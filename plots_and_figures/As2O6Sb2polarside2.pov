...
atom(<  2.01, -13.62, -24.08>, 0.33, rgb <1.00, 0.05, 0.05>, 0.0, ase3) // #2
atom(<  0.57, -15.12, -25.93>, 0.33, rgb <1.00, 0.05, 0.05>, 0.0, ase3) // #3
atom(< -0.57, -12.29, -23.83>, 0.33, rgb <1.00, 0.05, 0.05>, 0.0, ase3) // #4
atom(< -1.49, -15.26, -23.78>, 0.33, rgb <1.00, 0.05, 0.05>, 0.0, ase3) // #5
atom(<  1.49, -12.45, -26.34>, 0.33, rgb <1.00, 0.05, 0.05>, 0.0, ase3) // #6
atom(<  2.08,  -8.47, -26.29>, 0.59, rgb <0.74, 0.50, 0.89>, 0.0, ase3) // #7
atom(< -1.35,  -8.98, -26.15>, 0.69, rgb <0.62, 0.39, 0.71>, 0.0, ase3) // #8
atom(< -2.01, -10.81, -26.64>, 0.33, rgb <1.00, 0.05, 0.05>, 0.0, ase3) // #9
atom(<  2.01,  -7.98, -24.54>, 0.33, rgb <1.00, 0.05, 0.05>, 0.0, ase3) // #10
atom(<  0.57,  -9.48, -26.39>, 0.33, rgb <1.00, 0.05, 0.05>, 0.0, ase3) // #11
atom(< -0.57,  -6.65, -24.29>, 0.33, rgb <1.00, 0.05, 0.05>, 0.0, ase3) // #12
atom(< -1.49,  -9.62, -24.24>, 0.33, rgb <1.00, 0.05, 0.05>, 0.0, ase3) // #13
atom(<  1.49,  -6.82, -26.80>, 0.33, rgb <1.00, 0.05, 0.05>, 0.0, ase3) // #14
atom(< -1.35,  -3.34, -26.61>, 0.69, rgb <0.62, 0.39, 0.71>, 0.0, ase3) // #15
atom(< -2.01,  -5.18, -27.10>, 0.33, rgb <1.00, 0.05, 0.05>, 0.0, ase3) // #16
atom(<  0.57,  -3.84, -26.85>, 0.33, rgb <1.00, 0.05, 0.05>, 0.0, ase3) // #17
atom(< -1.49,  -3.99, -24.70>, 0.33, rgb <1.00, 0.05, 0.05>, 0.0, ase3) // #18
atom(<  2.08, -14.09, -21.17>, 0.59, rgb <0.74, 0.50, 0.89>, 0.0, ase3) // #19
atom(< -1.35, -14.60, -21.03>, 0.69, rgb <0.62, 0.39, 0.71>, 0.0, ase3) // #20
atom(<  1.35, -11.79, -23.59>, 0.69, rgb <0.62, 0.39, 0.71>, 0.0, ase3) // #21
atom(<  2.01, -13.60, -19.42>, 0.33, rgb <1.00, 0.05, 0.05>, 0.0, ase3) // #22
atom(<  0.57, -15.09, -21.27>, 0.33, rgb <1.00, 0.05, 0.05>, 0.0, ase3) // #23
atom(< -0.57, -12.27, -19.18>, 0.33, rgb <1.00, 0.05, 0.05>, 0.0, ase3) // #24
atom(< -1.49, -15.24, -19.12>, 0.33, rgb <1.00, 0.05, 0.05>, 0.0, ase3) // #25
atom(<  1.49, -12.43, -21.68>, 0.33, rgb <1.00, 0.05, 0.05>, 0.0, ase3) // #26
atom(< -2.08, -11.28, -23.73>, 0.59, rgb <0.74, 0.50, 0.89>, 0.0, ase3) // #27
atom(<  2.08,  -8.45, -21.63>, 0.59, rgb <0.74, 0.50, 0.89>, 0.0, ase3) // #28
atom(< -1.35,  -8.96, -21.49>, 0.69, rgb <0.62, 0.39, 0.71>, 0.0, ase3) // #29
atom(<  1.35,  -6.15, -24.05>, 0.69, rgb <0.62, 0.39, 0.71>, 0.0, ase3) // #30
atom(< -2.01, -10.79, -21.98>, 0.33, rgb <1.00, 0.05, 0.05>, 0.0, ase3) // #31
atom(<  2.01,  -7.96, -19.88>, 0.33, rgb <1.00, 0.05, 0.05>, 0.0, ase3) // #32
atom(<  0.57,  -9.46, -21.73>, 0.33, rgb <1.00, 0.05, 0.05>, 0.0, ase3) // #33
atom(< -0.57,  -6.63, -19.63>, 0.33, rgb <1.00, 0.05, 0.05>, 0.0, ase3) // #34
atom(< -1.49,  -9.60, -19.58>, 0.33, rgb <1.00, 0.05, 0.05>, 0.0, ase3) // #35
atom(<  1.49,  -6.79, -22.14>, 0.33, rgb <1.00, 0.05, 0.05>, 0.0, ase3) // #36
atom(< -2.08,  -5.64, -24.19>, 0.59, rgb <0.74, 0.50, 0.89>, 0.0, ase3) // #37
atom(< -1.35,  -3.32, -21.95>, 0.69, rgb <0.62, 0.39, 0.71>, 0.0, ase3) // #38
atom(< -2.01,  -5.15, -22.44>, 0.33, rgb <1.00, 0.05, 0.05>, 0.0, ase3) // #39
atom(<  0.57,  -3.82, -22.19>, 0.33, rgb <1.00, 0.05, 0.05>, 0.0, ase3) // #40
atom(< -1.49,  -3.96, -20.04>, 0.33, rgb <1.00, 0.05, 0.05>, 0.0, ase3) // #41
atom(<  2.08, -14.07, -16.51>, 0.59, rgb <0.74, 0.50, 0.89>, 0.0, ase3) // #42
atom(< -1.35, -14.57, -16.38>, 0.69, rgb <0.62, 0.39, 0.71>, 0.0, ase3) // #43
atom(<  1.35, -11.77, -18.93>, 0.69, rgb <0.62, 0.39, 0.71>, 0.0, ase3) // #44
atom(<  2.01, -13.58, -14.77>, 0.33, rgb <1.00, 0.05, 0.05>, 0.0, ase3) // #45
atom(<  0.57, -15.07, -16.62>, 0.33, rgb <1.00, 0.05, 0.05>, 0.0, ase3) // #46
atom(< -0.57, -12.24, -14.52>, 0.33, rgb <1.00, 0.05, 0.05>, 0.0, ase3) // #47
atom(< -1.49, -15.22, -14.47>, 0.33, rgb <1.00, 0.05, 0.05>, 0.0, ase3) // #48
atom(<  1.49, -12.41, -17.02>, 0.33, rgb <1.00, 0.05, 0.05>, 0.0, ase3) // #49
atom(< -2.08, -11.26, -19.07>, 0.59, rgb <0.74, 0.50, 0.89>, 0.0, ase3) // #50
atom(<  2.08,  -8.43, -16.97>, 0.59, rgb <0.74, 0.50, 0.89>, 0.0, ase3) // #51
atom(< -1.35,  -8.94, -16.84>, 0.69, rgb <0.62, 0.39, 0.71>, 0.0, ase3) // #52
atom(<  1.35,  -6.13, -19.39>, 0.69, rgb <0.62, 0.39, 0.71>, 0.0, ase3) // #53
atom(< -2.01, -10.77, -17.33>, 0.33, rgb <1.00, 0.05, 0.05>, 0.0, ase3) // #54
atom(<  2.01,  -7.94, -15.23>, 0.33, rgb <1.00, 0.05, 0.05>, 0.0, ase3) // #55
atom(<  0.57,  -9.44, -17.08>, 0.33, rgb <1.00, 0.05, 0.05>, 0.0, ase3) // #56
atom(< -0.57,  -6.61, -14.98>, 0.33, rgb <1.00, 0.05, 0.05>, 0.0, ase3) // #57
atom(< -1.49,  -9.58, -14.93>, 0.33, rgb <1.00, 0.05, 0.05>, 0.0, ase3) // #58
atom(<  1.49,  -6.77, -17.48>, 0.33, rgb <1.00, 0.05, 0.05>, 0.0, ase3) // #59
atom(< -2.08,  -5.62, -19.53>, 0.59, rgb <0.74, 0.50, 0.89>, 0.0, ase3) // #60
atom(< -1.35,  -3.30, -17.30>, 0.69, rgb <0.62, 0.39, 0.71>, 0.0, ase3) // #61
atom(< -2.01,  -5.13, -17.79>, 0.33, rgb <1.00, 0.05, 0.05>, 0.0, ase3) // #62
atom(<  0.57,  -3.80, -17.54>, 0.33, rgb <1.00, 0.05, 0.05>, 0.0, ase3) // #63
atom(< -1.49,  -3.94, -15.39>, 0.33, rgb <1.00, 0.05, 0.05>, 0.0, ase3) // #64
atom(<  1.35, -11.74, -14.28>, 0.69, rgb <0.62, 0.39, 0.71>, 0.0, ase3) // #65
atom(< -2.08, -11.24, -14.41>, 0.59, rgb <0.74, 0.50, 0.89>, 0.0, ase3) // #66
atom(<  1.35,  -6.11, -14.74>, 0.69, rgb <0.62, 0.39, 0.71>, 0.0, ase3) // #67
atom(< -2.08,  -5.60, -14.87>, 0.59, rgb <0.74, 0.50, 0.89>, 0.0, ase3) // #68
...
cylinder {< -1.35,  -3.34, -26.61>, < -1.42,  -3.66, -25.65>, Rbond texture{pigment {color rgb <0.62, 0.39, 0.71> transmit 0.0} finish{ase3}}}
cylinder {< -1.49,  -3.99, -24.70>, < -1.42,  -3.66, -25.65>, Rbond texture{pigment {color rgb <1.00, 0.05, 0.05> transmit 0.0} finish{ase3}}}
cylinder {< -1.35,  -3.34, -26.61>, < -0.39,  -3.59, -26.73>, Rbond texture{pigment {color rgb <0.62, 0.39, 0.71> transmit 0.0} finish{ase3}}}
cylinder {<  0.57,  -3.84, -26.85>, < -0.39,  -3.59, -26.73>, Rbond texture{pigment {color rgb <1.00, 0.05, 0.05> transmit 0.0} finish{ase3}}}
cylinder {< -1.35,  -3.34, -26.61>, < -1.68,  -4.26, -26.85>, Rbond texture{pigment {color rgb <0.62, 0.39, 0.71> transmit 0.0} finish{ase3}}}
cylinder {< -2.01,  -5.18, -27.10>, < -1.68,  -4.26, -26.85>, Rbond texture{pigment {color rgb <1.00, 0.05, 0.05> transmit 0.0} finish{ase3}}}
cylinder {< -1.49,  -3.99, -24.70>, < -1.79,  -4.81, -24.44>, Rbond texture{pigment {color rgb <1.00, 0.05, 0.05> transmit 0.0} finish{ase3}}}
cylinder {< -2.08,  -5.64, -24.19>, < -1.79,  -4.81, -24.44>, Rbond texture{pigment {color rgb <0.74, 0.50, 0.89> transmit 0.0} finish{ase3}}}
...
cylinder {< -1.35,  -3.32, -21.95>, < -1.68,  -4.24, -22.20>, Rbond texture{pigment {color rgb <0.62, 0.39, 0.71> transmit 0.0} finish{ase3}}}
cylinder {< -2.01,  -5.15, -22.44>, < -1.68,  -4.24, -22.20>, Rbond texture{pigment {color rgb <1.00, 0.05, 0.05> transmit 0.0} finish{ase3}}}
cylinder {< -1.35,  -3.32, -21.95>, < -0.39,  -3.57, -22.07>, Rbond texture{pigment {color rgb <0.62, 0.39, 0.71> transmit 0.0} finish{ase3}}}
cylinder {<  0.57,  -3.82, -22.19>, < -0.39,  -3.57, -22.07>, Rbond texture{pigment {color rgb <1.00, 0.05, 0.05> transmit 0.0} finish{ase3}}}
cylinder {< -1.35,  -3.32, -21.95>, < -1.42,  -3.64, -21.00>, Rbond texture{pigment {color rgb <0.62, 0.39, 0.71> transmit 0.0} finish{ase3}}}
cylinder {< -1.49,  -3.96, -20.04>, < -1.42,  -3.64, -21.00>, Rbond texture{pigment {color rgb <1.00, 0.05, 0.05> transmit 0.0} finish{ase3}}}
cylinder {< -1.49,  -3.96, -20.04>, < -1.79,  -4.79, -19.79>, Rbond texture{pigment {color rgb <1.00, 0.05, 0.05> transmit 0.0} finish{ase3}}}
cylinder {< -2.08,  -5.62, -19.53>, < -1.79,  -4.79, -19.79>, Rbond texture{pigment {color rgb <0.74, 0.50, 0.89> transmit 0.0} finish{ase3}}}
...
cylinder {<  2.01, -13.58, -14.77>, <  1.68, -12.66, -14.52>, Rbond texture{pigment {color rgb <1.00, 0.05, 0.05> transmit 0.0} finish{ase3}}}
cylinder {<  1.35, -11.74, -14.28>, <  1.68, -12.66, -14.52>, Rbond texture{pigment {color rgb <0.62, 0.39, 0.71> transmit 0.0} finish{ase3}}}
cylinder {< -0.57, -12.24, -14.52>, <  0.39, -11.99, -14.40>, Rbond texture{pigment {color rgb <1.00, 0.05, 0.05> transmit 0.0} finish{ase3}}}
cylinder {<  1.35, -11.74, -14.28>, <  0.39, -11.99, -14.40>, Rbond texture{pigment {color rgb <0.62, 0.39, 0.71> transmit 0.0} finish{ase3}}}
...
cylinder {< -1.35,  -3.30, -17.30>, < -0.39,  -3.55, -17.42>, Rbond texture{pigment {color rgb <0.62, 0.39, 0.71> transmit 0.0} finish{ase3}}}
cylinder {<  0.57,  -3.80, -17.54>, < -0.39,  -3.55, -17.42>, Rbond texture{pigment {color rgb <1.00, 0.05, 0.05> transmit 0.0} finish{ase3}}}
cylinder {< -1.35,  -3.30, -17.30>, < -1.42,  -3.62, -16.34>, Rbond texture{pigment {color rgb <0.62, 0.39, 0.71> transmit 0.0} finish{ase3}}}
cylinder {< -1.49,  -3.94, -15.39>, < -1.42,  -3.62, -16.34>, Rbond texture{pigment {color rgb <1.00, 0.05, 0.05> transmit 0.0} finish{ase3}}}
cylinder {< -1.35,  -3.30, -17.30>, < -1.68,  -4.22, -17.54>, Rbond texture{pigment {color rgb <0.62, 0.39, 0.71> transmit 0.0} finish{ase3}}}
cylinder {< -2.01,  -5.13, -17.79>, < -1.68,  -4.22, -17.54>, Rbond texture{pigment {color rgb <1.00, 0.05, 0.05> transmit 0.0} finish{ase3}}}
cylinder {< -1.49,  -3.94, -15.39>, < -1.79,  -4.77, -15.13>, Rbond texture{pigment {color rgb <1.00, 0.05, 0.05> transmit 0.0} finish{ase3}}}
cylinder {< -2.08,  -5.60, -14.87>, < -1.79,  -4.77, -15.13>, Rbond texture{pigment {color rgb <0.74, 0.50, 0.89> transmit 0.0} finish{ase3}}}
// no constraints
