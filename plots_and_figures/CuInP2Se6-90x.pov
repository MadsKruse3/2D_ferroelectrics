...
atom(<  3.22,   1.16,  -3.72>, 0.54, rgb <1.00, 0.50, 0.00>, 0.0, ase3) // #23
atom(<  3.22,  -1.12,  -3.72>, 0.54, rgb <1.00, 0.50, 0.00>, 0.0, ase3) // #24
atom(<  1.10,   1.85,  -3.53>, 0.60, rgb <1.00, 0.63, 0.00>, 0.0, ase3) // #25
atom(<  2.29,  -1.72,  -1.82>, 0.60, rgb <1.00, 0.63, 0.00>, 0.0, ase3) // #26
atom(<  2.04,  -1.72,  -5.48>, 0.60, rgb <1.00, 0.63, 0.00>, 0.0, ase3) // #27
atom(< -0.00,   1.48,  -5.58>, 0.66, rgb <0.78, 0.50, 0.20>, 0.0, ase3) // #28
atom(<  3.22,  -0.23,  -7.45>, 0.71, rgb <0.65, 0.46, 0.45>, 0.0, ase3) // #29
atom(< -0.00,   1.16,  -9.31>, 0.54, rgb <1.00, 0.50, 0.00>, 0.0, ase3) // #30
atom(< -0.00,  -1.12,  -9.31>, 0.54, rgb <1.00, 0.50, 0.00>, 0.0, ase3) // #31
atom(<  0.89,   1.85, -11.25>, 0.60, rgb <1.00, 0.63, 0.00>, 0.0, ase3) // #32
atom(<  1.23,   1.85,  -7.56>, 0.60, rgb <1.00, 0.63, 0.00>, 0.0, ase3) // #33
atom(< -2.13,   1.85,  -9.11>, 0.60, rgb <1.00, 0.63, 0.00>, 0.0, ase3) // #34
atom(<  2.11,  -1.72,  -9.45>, 0.60, rgb <1.00, 0.63, 0.00>, 0.0, ase3) // #35
atom(< -0.93,  -1.72,  -7.41>, 0.60, rgb <1.00, 0.63, 0.00>, 0.0, ase3) // #36
atom(< -1.18,  -1.72, -11.07>, 0.60, rgb <1.00, 0.63, 0.00>, 0.0, ase3) // #37
atom(< -3.22,   1.48, -11.17>, 0.66, rgb <0.78, 0.50, 0.20>, 0.0, ase3) // #38
atom(<  3.22,   1.48, -11.17>, 0.66, rgb <0.78, 0.50, 0.20>, 0.0, ase3) // #39
